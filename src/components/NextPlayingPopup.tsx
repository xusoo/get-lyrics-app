  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex flex-col rounded-2xl bg-black/85 backdrop-blur-xl border border-white/10 shadow-2xl overflow-hidden hover:bg-black/90 active:scale-[0.98] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
      >
        ...
        <div className="h-1 bg-white/15">
          <div ref={barRef} className="h-full bg-neutral-300 w-0" />
        </div>
      </button>
    </div>
  );
