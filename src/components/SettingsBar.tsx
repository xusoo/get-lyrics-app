...
export function SettingsBar({ offsetMs, isManuallySet, onOpenSettings, onOpenPicker, onAdjustOffset, onResetOffset }: SettingsBarProps) {
  ...
  return (
    <div className="fixed top-4 right-4 z-30 flex items-center gap-1.5 sm:gap-2">
      <IconBtn onClick={onOpenSettings} label="Settings">
        <Settings size={20} />
      </IconBtn>

      {/* Per-song offset controls */}
